/** Relationship id the chart slide's own generated rels register the copied background picture under. */
export const CHART_BG_REL_ID = "rId2";

/** Inner hole as a fraction of outer diameter — higher = thinner ring (0.65 ≈ 35% ring thickness). */
