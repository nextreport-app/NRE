...
/** Builds a plain `<p:pic>` at an arbitrary position/size, referencing an already-registered relationship id — the shape-building half of embedImageInSlide below, split out so it's independently testable. */
