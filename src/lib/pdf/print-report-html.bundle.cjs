...
// src/components/share-report-branding-header.tsx
var import_jsx_runtime = require("react/jsx-runtime");
function ShareReportBrandingHeader({
  brandingDisplay,
  branding,
  shareToken,
  rightSlot
}) {
  const agencyLogoSrc = branding.agencyLogoUrl && shareToken ? `/api/r/${shareToken}/agency-logo` : null;
    ...
    "header",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto flex max-w-[960px] items-center justify-between gap-2 sm:min-h-[56px] sm:gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex min-w-0 items-center gap-1.5 sm:gap-2", children: brandingDisplay.showNextReportLogo ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: "/logo.png", alt: "NextReport logo", className: "h-7 w-7 shrink-0 sm:h-9 sm:w-9" }),
        ...
        ] }) : agencyLogoSrc ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "img",
            {
              src: agencyLogoSrc,
          ...
          brandingDisplay.headerTitle ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "span",
            {
              className: "truncate text-[17px] font-bold text-ink sm:text-[22px]",
              style: { fontFamily: "var(--font-inter), sans-serif" },
              children: brandingDisplay.headerTitle
            }
          ) : null
        ] }) : brandingDisplay.headerTitle ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
        ...
        ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-[15px] font-semibold text-ink-muted", children: "Performance Report" }) }),
      ...
      children: [
        !isPrint ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ShareReportBrandingHeader,
          {
            ...
            branding,
            shareToken,
            rightSlot: shareToken ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
              "a",
              {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("main", { className: "mx-auto max-w-4xl px-4 py-8 sm:px-6", children: [
        ...
        !isPrint && shareToken ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-8 text-center text-xs text-slate-600", children: brandingDisplay.footerPrimary ?? (brandingDisplay.showNextReportLogo ? `Shared via NextReport \xB7 ${shareToken.slice(0, 6)}\u2026` : null) }) : null
      ] })
    }
  );
}
