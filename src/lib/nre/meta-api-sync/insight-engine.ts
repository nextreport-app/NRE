/**
 * Maps one Meta Insights row → the same Result type / Results / CPR fields
 * as a manual Ads Manager daily export. All campaign-type rules live here.
 */
...
/** One row per campaign + ad set + day — same grain as manual Meta CSV exports. */
...
/** Same algorithm as pickResultAction — manual export primary result for one insight day. */
