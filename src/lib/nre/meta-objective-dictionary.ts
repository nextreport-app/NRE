...
export const META_FUZZY_CATALOG: readonly MetaFuzzyCatalogEntry[] = [
  ...
  },
  {
    resultLabel: "QUALIFIED LEADS",
    costLabel: "COST PER QUALIFIED LEAD",
    pattern: /qualified\s*leads?|quality\s*leads?/,
    canonicalText: "Qualified lead",
  },
  {
    resultLabel: "REMINDERS SET",
    costLabel: "COST PER REMINDER",
    pattern: /reminders?\s*set|reminder\s*set/,
    canonicalText: "Reminder set",
  },
  {
    resultLabel: "PRE-REGISTRATION",
    costLabel: "COST PER PRE-REGISTRATION",
    pattern: /pre[\s-]*registrations?/,
    canonicalText: "Pre-registration",
  },
  {
    resultLabel: "QUOTE REQUESTS",
    costLabel: "COST PER QUOTE",
    pattern: /quote[\s_]*requests?|quote\s*request\s*submitted/,
    canonicalText: "Quote request",
  },
  {
    resultLabel: "GROUP JOINS",
