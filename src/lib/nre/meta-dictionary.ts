...
export const META_METRIC_DICTIONARY: MetaMetricDefinition[] = [
  ...
  {
    csvName: "cost per website lead",
    key: "cost_per_website_lead",
  ...
  {
    csvName: "purchases conversion value",
    key: "purchases_conversion_value",
    label: "PURCHASE VALUE",
    type: "secondary",
    format: "currency",
    objectives: ["sales"],
  ...
  {
    csvName: "purchase roas (return on ad spend)",
    key: "results_roas",
    label: "PURCHASE ROAS",
    type: "secondary",
    format: "ratio",
  ...
  },
  {
    ...
    objectives: ["sales"],
    priority: 73,
    explanation: "Average cost per add-to-cart action",
    perUnitOf: "add_to_cart",
  },
  {
    csvName: "initiate checkout",
    ...
    objectives: ["sales"],
    priority: 77,
    explanation: "Number of times people started the checkout process",
  },
  {
    csvName: "cost per initiate checkout",
    key: "cost_per_initiate_checkout",
