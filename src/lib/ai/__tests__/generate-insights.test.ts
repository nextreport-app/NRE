...
function makeReportData(
  ...
  return {
    ...
    pausedMessage: null,
    chart: null,
    periodRow: { hasData: false, monthLabel: "—", monthName: null, spend: "—", reach: "—", impressions: "—", ctr: "—", cpc: "—", resultColumns: [{ label: "RESULTS", costLabel: "COST PER RESULT", value: "0", cprValue: "—" }] },
    mtdRow: { hasData: false, monthLabel: "—", monthName: null, spend: "—", reach: "—", impressions: "—", ctr: "—", cpc: "—", resultColumns: [{ label: "RESULTS", costLabel: "COST PER RESULT", value: "0", cprValue: "—" }] },
    combinedTotalNote: null,
