    ...
    <section className="border-t-4 border-accent-orange bg-navy px-6 py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-5 text-base leading-relaxed text-ink-muted">
          The average digital agency spends 3-4 hours per client per week manually downloading data,
          formatting slides, and writing campaign summaries. With 10 clients that is 30-40 hours every
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-[1fr_auto_1fr] sm:items-center sm:gap-4">
          <div className="rounded-xl border border-navy-border bg-navy-panel p-6">
            ...
            <p className="mt-2 text-xl font-semibold text-white">10 clients × 3 hours</p>
            <p className="mt-1 text-sm font-medium text-red-400">= 30 hours/week</p>
          </div>
