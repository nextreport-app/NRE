...
export const metadata: Metadata = pageMetadata({
  title: "Pricing",
  description:
    "Simple pricing for automated Meta Ads, Google Ads, and GA4 reporting. Starter from $8/month, Professional from $20/month. 7-day free trial, live browser share link, and PDF download included.",
  path: "/pricing",
});
...
const FAQS = [
  ...
  {
    q: "Can I connect Meta, Google Ads, or GA4 directly instead of uploading a CSV?",
    a: "Yes — NextReport syncs with Meta's Marketing API, Google's Ads API, and GA4's Data API. Connect your accounts in Account Settings and choose Sync from API in the report wizard. CSV upload remains fully supported if you prefer manual exports.",
  },
  {
  ...
  {
    q: "What is the difference between Meta Ads, Google Ads, and GA4 reporting?",
    a: "Meta and Google Ads reports use the same dark navy branded template with platform-specific metrics — Meta shows reach, frequency, leads and link clicks while Google shows clicks, impressions, conversions and quality score. GA4 website reports cover traffic, channels, landing pages, and breakdowns you choose in the wizard.",
  },
  {
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-16">
        ...
        <div className="mt-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base text-ink-muted">
            Everything you need to automate Meta Ads, Google Ads, and GA4 reporting. Connect via official API or upload a CSV —
